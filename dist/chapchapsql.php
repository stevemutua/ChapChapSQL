...
trait misc {
  ...
  /**
   * Returns the standard ChapchapSQL JSON output, after a successful or failed method call
   *
   ...
   * @return    string                returns a JSON string containing the standard ChapchapSQL output
   */
  ...
  /**
   * Decodes a standard ChapchapSQL JSON output & throws exception if the status value !== "success"
   * You can use this function to process ouput from CRUD operations & handle errors gracefully
   *
   * @param     $json_content         JSON string containing the standard ChapchapSQL output
   * @return    array                 array containing the data returned from a ChapchapSQL method call
   * @throws    Exception             if the status value from the ChapchapSQL output !== "success"
   */
...
abstract class credentials extends init
{
   ...
   * @return    string                returns the standard ChapchapSQL JSON output containing a successful method call
...
abstract class logs extends credentials
{
   ...
   *
   * @param     $error_content        JSON string specifying the error details from a failed ChapchapSQL method call
